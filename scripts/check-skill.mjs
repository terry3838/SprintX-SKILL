...
const requiredChecks = [
  ...
  [/^\s+env:\s*$/m, "requires.env block is required"],
  [/^\s+-\s+SX_ACCESS_TOKEN$/m, "requires.env must declare SX_ACCESS_TOKEN for the advanced override path"],
  [/^\s+-\s+SX_API_URL$/m, "requires.env must declare SX_API_URL because troubleshooting references it"],
